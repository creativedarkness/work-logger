...
class WorkLogger extends Component {
        ...
        validate = (props) => {
            ...
            minutes = this.state.minutesWorked.value < 0 && this.state.minutesWorked.value > 240 ? false : true;
            ...
            return (
                <div>
                    <form onSubmit={this.handleSubmit}>
                        ...
                        {!this.state.vaildMinutes && !this.state.minutesBlank? <span>Please enter a number between 0 and 240</span> : null}
                        <br/>
